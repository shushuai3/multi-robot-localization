...
# MAE_x_formation = ax1.contourf(X, Y, xErr_formation, cmap=plt.cm.get_cmap("coolwarm"))
# fig.colorbar(MAE_x_formation, ax=ax1)
# ax1.set_title('Formation: MAE X (m)')
# MAE_x_hover = ax2.contourf(X, Y, xErr_hover, cmap=plt.cm.get_cmap("coolwarm"))
# fig.colorbar(MAE_x_hover, ax=ax2)
# ax2.set_title('Hover: MAE X (m)')
# MAE_y_formation = ax3.contourf(X, Y, yErr_formation, cmap=plt.cm.get_cmap("coolwarm"))
# fig.colorbar(MAE_y_formation, ax=ax3)
# ax3.set_title('Formation: MAE Y (m)')
# MAE_y_hover = ax4.contourf(X, Y, yErr_hover, cmap=plt.cm.get_cmap("coolwarm"))
# fig.colorbar(MAE_y_hover, ax=ax4)
# ax4.set_title('Hover: MAE Y (m)')

# ax1.set_xlabel('Velocity deviation (m/s)')
# ax1.set_ylabel('Ranging deviation (m)')
# ax2.set_xlabel('Velocity deviation (m/s)')
# ax2.set_ylabel('Ranging deviation (m)')
# ax3.set_xlabel('Velocity deviation (m/s)')
# ax3.set_ylabel('Ranging deviation (m)')
# ax4.set_xlabel('Velocity deviation (m/s)')
# ax4.set_ylabel('Ranging deviation (m)')
# plt.show()